...
<head>
	...
	<link rel="stylesheet" type="text/css" href="./css/cladmin.css" />
...
<body data-target="#nino-navbar" data-spy="scroll">
    ...
    <!--table width="1200"  border="3" bordercolor="blue" align="center"-->
    <table border="3" id="teaTab" align="center">
        <thead align="center">
            <tr bgcolor="#87CEFA">
...
<td><h3>地址</h3></td>
 <td  width="60"><h3>編輯</h3></td>
    ...
    <!--table width="1200"  border="3" bordercolor="red" align="center"-->
