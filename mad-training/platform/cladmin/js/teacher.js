...
$("#teaTab .donebtn").click(function(){
	...
	$.get("update.php", {"id_value":teaid,"name_value":tea_name_value, "parent_value":"",
...
$("#teaTab .deletebtn").click(function(){
	...
	$.get("delete.php", {"id_value":teaid}, function(results){
...
$("#teaTab .resetpwdbtn").click(function(){
	...
	$.get("resetpwd.php",{"id_value":teaid},function(results){
...
$("#teaTab .addteabtn").click(function(){
