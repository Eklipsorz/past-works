...
$("#stuTab .donebtn").click(function(){
	...
	$.get("update.php", {"id_value":stuid,"name_value":stu_name_value, "parent_value":stu_parent_value,
...
$("#stuTab .deletebtn").click(function(){
	...
	$.get("delete.php", {"id_value":stuid}, function(results){
...
$("#stuTab .resetpwdbtn").click(function(){
	...
	$.get("resetpwd.php",{"id_value":stuid},function(results){
...
$("#stuTab .addstubtn").click(function(){
