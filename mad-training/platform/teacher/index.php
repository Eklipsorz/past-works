...
<body data-target="#nino-navbar" data-spy="scroll">
	...
	<section>
        <div class="container">
                <div class="row">
                        <div class="col-md-4">  					
							<div class="btn" onclick="location.href='setquiz.php'">考試<br>管理</div>
					   </div>
					   <div class="col-md-4">                              
							<div class="btn" onclick="location.href='StuManager.php'">學生<br>管理</div>
					   </div>
					   <div class="col-md-4">                              
							<div class="btn" onclick="location.href='scorelist.php'">成績<br>管理</div>
					   </div>
				</div>									
		</div>
